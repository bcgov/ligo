...
LOCAL_APPS = (
    # custom users app
    'linkage.users.apps.UsersConfig',
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'linkage.contrib.sites.migrations'
}
...
ACCOUNT_EMAIL_VERIFICATION = 'none' #probable values 'mandatory', 'none', 'optional'

ACCOUNT_ALLOW_REGISTRATION = env.bool('DJANGO_ACCOUNT_ALLOW_REGISTRATION', False)
ACCOUNT_ADAPTER = 'linkage.users.adapters.AccountAdapter'
SOCIALACCOUNT_ADAPTER = 'linkage.users.adapters.SocialAccountAdapter'
...
########## CELERY
INSTALLED_APPS += ('linkage.taskapp.celery.CeleryConfig',)
