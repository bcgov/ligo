...
if dropdb -h postgres2 -U $POSTGRES_USER $POSTGRES_USER
...
createdb -h postgres2 -U $POSTGRES_USER $POSTGRES_USER -O $POSTGRES_USER

# restore the database
echo "restoring database $POSTGRES_USER"
gunzip -c $BACKUPFILE | psql -h postgres2 -U $POSTGRES_USER
